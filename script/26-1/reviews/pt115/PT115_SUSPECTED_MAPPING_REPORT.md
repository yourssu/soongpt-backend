...
- 규칙: 5006762501/5006762502 기초공학수학1 원본 대상 텍스트 및 target 정합성 보정 완료로 보고서에서 제외
- 제외 수: **2건**
- 코드: `5006762501, 5006762502`

## 이슈 집계

- `UNMAPPED_NON_FUSION_TOKEN`: **93건**
...
4. [2150046801] `International organization & Treaty`
   - 개설학과: `국제법무학과`
...
45. [2150370501] `Understanding Foreign Policy`
   - 개설학과: `정치외교학과`
   - 분류: `MAJOR_ELECTIVE` / `전선-정외`
...
84. [2150660501] `Intellectual Property Law`
   - 개설학과: `국제법무학과`
   - 분류: `MAJOR_ELECTIVE` / `전선-국제법무`
...
85. [2150664701] `Int'l Business Transaction`
   - 개설학과: `국제법무학과`
   - 분류: `MAJOR_ELECTIVE` / `전선-국제법무`
   - 원본 대상: `4학년 국제법무학과,통일외교및개발협력`
   - 이슈: `UNMAPPED_NON_FUSION_TOKEN`
